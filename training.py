...
device = torch.device("cuda:0") # initiate GPU

bertmodel, vocab = get_pytorch_kobert_model()

dataset_train = nlp.data.TSVDataset('train.tsv', field_indices=[1,2], num_discard_samples=1) # training dataset
dataset_test = nlp.data.TSVDataset('validation.tsv', field_indices=[1,2], num_discard_samples=1) # testing dataset
...
class BERTClassifier(nn.Module):
    def __init__(self, bert, hidden_size = 768, num_classes = class_num, dr_rate=None, params=None):
